...
Stripped-down version for single-image alignment in the AgeVisionProject pipeline.
Original: https://github.com/yuval-alaluf/SAM
"""
import numpy as np
import PIL
import PIL.Image
...
def get_landmark(filepath, predictor):
    """Get 68 facial landmarks with dlib.
...
def align_face(filepath, predictor):
    """Align a face image using FFHQ-style alignment.
    ...
    Returns:
        PIL Image (256x256) with aligned face.
    """
